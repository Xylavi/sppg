        ...
        <nav class="mx-auto max-w-6xl px-4 py-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between">
                ...
                <button id="mobile-nav-trigger" type="button"
                    class="rounded-lg border border-slate-200 px-3 py-2 text-sm font-semibold text-slate-700 md:hidden">
                    Menu
                </button>

                <ul class="hidden flex-wrap items-center gap-4 text-sm font-medium text-slate-700 md:flex">
            ...
            <ul id="mobile-nav" class="mt-4 hidden space-y-2 border-t border-slate-100 pt-4 text-sm font-medium text-slate-700 md:hidden">
